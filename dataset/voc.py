...
# * Date        : 2024-11-01
# * Version     : 0.1.110118
# * Description : VOC Dataset Classes
...
def main():
    ...
    # opt
    parser.add_argument('--root', default='/Users/liuhaoran/Desktop/python_work/object-detection/dataset/VOCdevkit/', help='data root')
    ...
    parser.add_argument('--is_train', action="store_true", default=False, help='mixup augmentation.')
    ...
    for i in range(1000):
        ...
        image = image.astype(np.uint8)  # to uint8
        image = image.copy()
        img_h, img_w = image.shape[:2]
