...
# ***************************************************
# * File        : yolov1_backbone.py
# * Author      : Zhefeng Wang
# * Email       : zfwang7@gmail.com
# * Date        : 2024-10-31
# * Version     : 1.0.103100
# * Description : YOLOv1 骨干网络：ResNet
# * Link        : link
...
def resnet18(pretrained = False, **kwargs):
    ...
    Args:
        pretrained (bool): 如果为 True，则加载 imagenet 预训练权重
    """
...
def build_backbone(model_name = 'resnet18', pretrained = False):
    if model_name == 'resnet18':
        ...
        feat_dim = 512    # 网络的最终输出的 feature 的通道维度为 512
    elif model_name == 'resnet34':
        model = resnet34(pretrained)
        feat_dim = 512    # 网络的最终输出的 feature 的通道维度为 512
    elif model_name == 'resnet50':
        model = resnet50(pretrained)
        feat_dim = 2048   # 网络的最终输出的 feature 的通道维度为 2048
...
# 测试代码 main 函数
def main():
    # 这是一段测试代码，方便读者测试能否正常的下载 ResNet 权重和调用 ResNet 网络
